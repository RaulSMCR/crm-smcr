...
export default function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md border">
      ...
      <div className="mb-4">
        <label htmlFor="email" className="block text-gray-700 font-medium mb-2">Tu Email</label>
      ...
      <div className="text-xs text-gray-500 mt-4 text-center space-y-2">
        ...
        <p className="font-bold">Si se trata de una emergencia, por favor contacte al 911.</p>
      </div>
    </form>
  );
}