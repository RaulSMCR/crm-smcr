    ...
    <section className="bg-brand-primary text-neutral-250">
      <div className="container mx-auto px-6 py-20 text-center">
        <h2 className="text-brand-600 text-3xl font-bold mb-4">
          Â¿Eres un profesional interesado aportar a la salud mental de sus clientes?
        </h2>
        <p className="text-brand-600 max-w-2xl mx-auto mb-8">
          Ãšnete a nuestro equipo interdisciplinario de especialistas en bienestar, mejore su efectividad y expanda su alcance.
        </p>
