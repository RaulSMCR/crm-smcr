  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      ...
      <div className="flex flex-wrap gap-2">
        <Link href="/panel/profesional/casos" className="text-sm inline-flex items-center rounded-xl border border-blue-200 bg-blue-50 px-4 py-2 font-medium text-blue-700 hover:bg-blue-100">
          Casos
        </Link>
        ...
        <Link href="/panel/profesional/tarifas" className="text-sm inline-flex items-center rounded-xl border border-blue-200 bg-blue-50 px-4 py-2 font-medium text-blue-700 hover:bg-blue-100">
          Lugares y tarifas
        </Link>
