// src/app/api/reports/payables/route.js
// CXP — Cuentas por Pagar: facturas de proveedor con saldo pendiente.
...
export async function GET(request) {
  try {
    ...
    const invoices = await prisma.invoice.findMany({
      ...
      select: {
        id: true, invoiceNumber: true, supplierReference: true,
    ...
    // Agrupar por proveedor (contactId)
    ...
    console.error("[reports/payables] GET error:", error);
